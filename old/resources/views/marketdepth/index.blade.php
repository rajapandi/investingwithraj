                ...
                <div class="col-md-12 col-xl-12 mb-4">
                    <div class="card">
                        <div class="card-body" id="card-body">
                            <div>
                                <h2 class="section-heading section-heading-ms">Market Depth</h2>
                                <button class="btn btn-primary btn-sm" onclick="createMarketDepth()"><i class="fa fa-plus" aria-hidden="true"></i> Create New</button>
                            </div><br>
