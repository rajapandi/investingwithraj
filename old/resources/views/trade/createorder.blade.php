                      ...
                      <div class="col-md-12">
                        ...
                        <form action="/trade/create" method="post"> 
                            ...
                            <table style="width:100%;">
                                <tr colspan="5">
                                    <td>
                                        ...
                                        if($_GET['type']=="buy"){
                                                ?>
                                                <input class="form-check-input" type="radio" name="transactiontype" id="transactiontype1" value="BUY" checked>
                                        ...
                                        if($_GET['type']=="sell"){
                                                ?>
                                            <input class="form-check-input" type="radio" name="transactiontype" id="transactiontype2" value="SELL" CHECKED>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td>
									    ...
									    <input type="text" class="form-control price" name="price" id="placePrice" value="<?php if(isset($_GET['price'])) echo $_GET['price'] ; else echo 0?>">
                                    </td>
                                    <td>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    <td>
                                        <select class="custom-select form-control" multiple name="accounts[]" id="accounts" required>
                                            <?php
                                            if(isset($_GET['group'])){
                                                $login_data = json_decode($_GET['login'], true);
