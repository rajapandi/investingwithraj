    ...
    <div class="sidebar py-3" id="sidebar">
      ...
      <ul class="list-unstyled">
          ...
          @endif
            ...
            @endif
            @if(Request::segment(1)=="schedular")
            <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#cmsDropdown21" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                    <svg class="svg-icon svg-icon-md me-3">
                      <use xlink:href="/assets/icons/orion-svg-sprite.57a86639.svg#time-1"> </use>
                    </svg><span class="sidebar-link-title">Schedular </span></a>
              <ul class="sidebar-menu list-unstyled collapse " id="cmsDropdown21">
                <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="/schedular/create">Create</a></li>
                <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="/schedular">Schedular</a></li>
              </ul>
            </li>
            @else
            <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#cmsDropdown21" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                    <svg class="svg-icon svg-icon-md me-3">
                      <use xlink:href="/assets/icons/orion-svg-sprite.57a86639.svg#time-1"> </use>
                    </svg><span class="sidebar-link-title">Schedular </span></a>
              <ul class="sidebar-menu list-unstyled collapse " id="cmsDropdown21">
