...
/****schedular */
Route::get('/schedular', 'SchedularController@index');
Route::get('/schedular/create', 'SchedularController@schedularOrder');

Route::post('/schedular/order', 'SchedularController@storeSchedular');

Route::get('/schedular/priceBasedSchedular', function(){
    return view('schedular.priceBasedSchedular');
});
Route::get('/schedular/timeBasedSchedular', function(){
    return view('schedular.timeBasedSchedular');
});
Route::get('/schedular/percentageBasedSchedular', function(){
    return view('schedular.percentageBasedSchedular');
});

Route::get('/getinstrumentsr', 'SchedularController@getInstruments');




Route::get('get-ltp', 'InstrumentsController@getLtp');



Route::get('store-instrument', 'InstrumentsController@storeInstruments');
